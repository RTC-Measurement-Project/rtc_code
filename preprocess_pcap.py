...
from utils import get_asn_description, read_from_json, save_dict_to_json, get_time_filter_from_str, find_timestamps, get_ip_type, load_config
...
def preprocess_pcap(pcap_main_folder, save_main_folder, apps, tests, rounds, client_types, precall_noise_duration, postcall_noise_duration, multiprocess=False):
    """
...
if __name__ == "__main__":
    # python preprocess_pcap.py --config config.json --multiprocess
    ...
    pcap_main_folder, save_main_folder, apps, tests, rounds, client_types, precall_noise_duration, postcall_noise_duration, _, _ = load_config(config_path)
    preprocess_pcap(pcap_main_folder, save_main_folder, apps, tests, rounds, client_types, precall_noise_duration, postcall_noise_duration, multiprocess=multiprocess)
